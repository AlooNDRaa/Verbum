    ...
    return (
        ...
        <div className="bg-[#101015] grid  h-screen text-white">
           <div className="flex items-center justify-center">
            <div>
                <svg width="500" height="100%" viewBox="0 0 858 790" fill="none" xmlns="http://www.w3.org/2000/svg">
             ...
             <div className="flex flex-col items-center gap-7">
                ...
                <Link to='/home'>
                     <button className='bg-pink-700 w-[15rem] rounded h-12 text-center hover:bg-pink-600 hover:text-[#daf] font-bold'>
                          Please, Go back
                    </button>
                 </Link>
             </div>
