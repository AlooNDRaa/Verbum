export function Tools() {
    return (
      <div className="flex justify-center">
        <div className="container flex flex-wrap lg:ml-6 justify-center md:justify-around xl:justify-around mt-[10rem]">
        <h1 className="text-white text-6xl xl:mt-0 mb-5 font-semibold font-['DM Sans']">
          Tools
        </h1>
      <div className="sm:mt-5 ml-2 flex flex-col flex-wrap">
        <h3 className="text-white lg:text-3xl text-center font-medium font-['DM Sans']">Send private messages</h3> <br />
        <h3 className="text-pink-600 lg:text-2xl text-center font-medium font-['DM Sans'] -mt-[20px]">Send free messages and calls in a <br />simple, reliable and private way</h3> <br />
        <h3 className="text-pink-600 lg:text-2xl font-medium text-center font-['DM Sans'] -mt-[20px]">available worldwide.</h3>
      </div>
        ...
        <div className="Cajas-horizontal mt-7 flex flex-wrap gap-7 justify-center xl:justify-around text-center aling-center ">
